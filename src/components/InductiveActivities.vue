<template>
  <div class="inductive-activities flex-column">
    ...
    <div class="content flex-one flex-column scrolly">
      <div class="activities-nav m2-bottom m2-top">
        <div class="flex-row flex-center activity-categories">
          <button class="button font4 pointer" :class="{clear: category !== 'observe'}" @click="category = 'observe'">Observe</button>
          <button class="button font4 m2-left m2-right pointer" :class="{clear: category !== 'interpret'}" @click="category = 'interpret'">Interpret</button>
          <button class="button font4 pointer" :class="{clear: category !== 'apply'}" @click="category = 'apply'">Apply</button>
        </div>
      ...
      <div class="flex-one flex-row p2">
        <div class="m1-right">
          <div v-if="category === 'observe'" class="flex-column">
            <p v-for="(title, i) in observeTitles" :key="i" @click="show(title)" class="p1 pointer" :class="{white: activeTitle === title}">{{title}}</p>
          </div>
          <div v-if="category === 'interpret'" class="flex-column">
            <p v-for="(title, i) in interpretTitles" :key="i" @click="show(title)" class="p1 pointer" :class="{white: activeTitle === title}">{{title}}</p>
          </div>
          <div v-if="category === 'apply'" class="flex-column">
            <p v-for="(title, i) in applyTitles" :key="i" @click="show(title)" class="p1 pointer" :class="{white: activeTitle === title}">{{title}}</p>
          </div>
        </div>
        ...
        <!-- OBSERVE -->
        <div class="activity shadow rounded bg-base p2">
