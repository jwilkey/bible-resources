<template>
  <div class="romans theme-back">
    <div class="flex-row align-center callout shadow">
      ...
      <h1 class="font-large pad">Romans</h1>
    </div>

    <div class="pad">
      <div :class="sessionClasses(1)" data-session="1" class="theme-mid pad rounded shadow marginb" @click="setSession(1)">
        ...
        <div class="detail hi-top">
          <div>
            ...
            <p>Abram's faith counted as righteousness <span class="callout alt">Genesis 15:1-6</span></p>
            <p>Abraham, father of many nations, given the sign of circumcission <span class="callout alt">17:1-11</span></p>
            <p>David speaks of the forgiveness of sin <span class="callout alt">Psalm 32:1-2</span></p>
            <p>The promise of death in response to disobedience <span class="callout alt">Genesis 2:15-18</span></p>
            <p>The fall of man <span class="callout alt">Genesis 3:1-6</span></p>
      ...
      <div :class="sessionClasses(2)" data-session="2" class="theme-mid pad rounded shadow marginb" @click="setSession(2)">
      ...
      <div :class="sessionClasses(3)" data-session="3" class="theme-mid pad rounded shadow marginb" @click="setSession(3)">
      ...
      <div :class="sessionClasses(4)" data-session="4" class="theme-mid pad rounded shadow marginb" @click="setSession(4)">
